                ...
                <div class="d-flex gap-8">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-3 row">
                                    ...
                                    <div class="">
                                        <select class="form-control select" data-minimum-results-for-search="Infinity" name="category_id">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3 row">
                                    ...
                                    <div class="">
                                        <select class="form-control select" data-minimum-results-for-search="Infinity" name="subcategory_id">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-3 row">
                                    ...
                                    <div class="">
                                        <select class="form-control select" data-minimum-results-for-search="Infinity" name="childcategory_id">
                                            <optgroup label="Child Category">
                                                @foreach ($childcategory as $childcategory)
                                                    <option value="{{$childcategory->id}}"> {{$childcategory->child_category_name}} </option>
                                                @endforeach
                                            </optgroup>
                                        </select>
                                    </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3 row">
                                    ...
                                    <div class="">
                                        <select class="form-control select" data-minimum-results-for-search="Infinity" name="brand_id">
                            ...
                            {{-- <div class="col-lg-6">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="">
                                            <select class="form-control select" data-minimum-results-for-search="Infinity" name="warehouse">
                    ...
                    <div class="card-body col-lg-4 flex m-4">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label for="toggleFour" class="flex cursor-pointer select-none items-center"> Featured Product
                                        <div class="relative">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label for="toggleFour" class="flex cursor-pointer select-none items-center"> Today's Deal
                                        <div class="relative">
                                        <input type="checkbox" id="toggleFour" class="sr-only" />
                                        <div class="box bg-dark block h-8 w-14 rounded-full"></div>
                                        <div
