                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <a href="#"
                                                    class="text-body fw-semibold letter-icon-title">Annabelle Doney</a>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-inline-block me-3">
                                                <img src="{{ asset('') }}assets/images/demo/logos/1.svg"
                                                    alt="" height="36">
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-inline-block me-3">
                                                <img src="{{ asset('') }}assets/images/demo/logos/2.svg"
                                                    alt="" height="36">
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-inline-block me-3">
                                                <img src="{{ asset('') }}assets/images/demo/logos/3.svg"
                                                    alt="" height="36">
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-inline-block me-3">
                                                <img src="{{ asset('') }}assets/images/demo/logos/4.svg"
                                                    alt="" height="36">
                                            </a>
                                            <div>
                            ...
                            <div class="d-flex align-items-start mb-3">
                                <div class="status-indicator-container me-3">
                                    <img src="{{ asset('') }}assets/images/demo/users/face10.jpg"
                                        class="rounded-circle" width="40" jeight="40" alt="">
