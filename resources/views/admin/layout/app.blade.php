		...
		<ul class="navbar-nav flex-row order-1 order-lg-2 flex-1 flex-lg-0 justify-content-end align-items-center">
			...
			<li class="nav-item nav-item-dropdown-lg dropdown dropdown-user h-100">
				<a href="#" class="navbar-nav-link navbar-nav-link-toggler dropdown-toggle d-inline-flex align-items-center h-100" data-toggle="dropdown">
					<img src="{{ asset('global_assets/images/placeholders/placeholder.jpg') }}" class="rounded-pill" height="34" alt="">
										...
										<div class="col-sm-4">
											<div class="d-flex align-items-center justify-content-center mb-2">
												...
												<div>
													...
													<span class="text-muted"><span class="badge badge-mark border-success-100 mr-2"></span> 5,378 avg</span>
												</div>
											</div>
								...
								<div class="card-body d-sm-flex align-items-sm-center justify-content-sm-between flex-sm-wrap">
									<div class="d-flex align-items-center mb-3 mb-sm-0">
										...
										<div class="ml-3">
											...
											<span class="badge badge-mark border-success-100 mr-1"></span> <span class="text-muted">May 12, 12:30 am</span>
										</div>
									</div>
									...
									<div class="d-flex align-items-center mb-3 mb-sm-0">
										...
										<div class="ml-3">
											<h5 class="font-weight-semibold mb-0">2,458 <span class="text-warning font-size-sm font-weight-normal"><i class="icon-arrow-down12"></i> (-4.9%)</span></h5>
											<span class="badge badge-mark border-warning-100 mr-1"></span> <span class="text-muted">Jun 4, 4:00 am</span>
										</div>
									</div>
											...
											<tr>
												<td>
													<div class="d-flex align-items-center">
														<div class="mr-3">
															<a href="#">
																<img src="{{ asset('global_assets/images/brands/facebook.svg') }}" class="rounded-circle" width="32" height="32" alt="">
															</a>
														</div>
														<div>
											...
											<tr>
												<td>
													<div class="d-flex align-items-center">
														<div class="mr-3">
															<a href="#">
																<img src="{{ asset('global_assets/images/brands/youtube.svg') }}" class="rounded-circle" width="32" height="32" alt="">
															</a>
														</div>
														<div>
											...
											<tr>
												<td>
													<div class="d-flex align-items-center">
														<div class="mr-3">
															<a href="#">
																<img src="{{ asset('global_assets/images/brands/spotify.svg') }}" class="rounded-circle" width="32" height="32" alt="">
															</a>
														</div>
														<div>
											...
											<tr>
												<td>
													<div class="d-flex align-items-center">
														<div class="mr-3">
															<a href="#">
																<img src="{{ asset('global_assets/images/brands/twitter.svg') }}" class="rounded-circle" width="32" height="32" alt="">
															</a>
														</div>
														<div>
											...
											<tr>
												<td>
													<div class="d-flex align-items-center">
														<div class="mr-3">
															<a href="#">
																<img src="{{ asset('global_assets/images/brands/bing.svg') }}" class="rounded-circle" width="32" height="32" alt="">
															</a>
														</div>
														<div>
											...
											<tr>
												<td>
													<div class="d-flex align-items-center">
														<div class="mr-3">
															<a href="#">
																<img src="{{ asset('global_assets/images/brands/amazon.svg') }}" class="rounded-circle" width="32" height="32" alt="">
															</a>
														</div>
														<div>
											...
											<tr>
												<td>
													<div class="d-flex align-items-center">
														<div class="mr-3">
															<a href="#">
																<img src="{{ asset('global_assets/images/brands/dribbble.svg') }}" class="rounded-circle" width="32" height="32" alt="">
															</a>
														</div>
														<div>
								...
								<div class="card-body d-lg-flex align-items-lg-center justify-content-lg-between flex-lg-wrap">
									<div class="d-flex align-items-center mb-3 mb-lg-0">
										...
										<div class="ml-3">
											...
											<span class="badge badge-mark border-success-100 mr-1"></span> <span class="text-muted">Jun 16, 10:00 am</span>
										</div>
									</div>
												...
												<td>
													<div class="d-flex align-items-center">
														...
														<div>
															...
															<div class="text-muted font-size-sm"><span class="badge badge-mark border-primary-100 mr-1"></span> Active</div>
														</div>
													</div>
												</td>
												<td>
												...
												<td>
													<div class="d-flex align-items-center">
														...
														<div>
															...
															<div class="text-muted font-size-sm"><span class="badge badge-mark border-success-100 mr-1"></span> Resolved</div>
														</div>
													</div>
												</td>
												<td>
												...
												<td>
													<div class="d-flex align-items-center">
														...
														<div>
															...
															<div class="text-muted font-size-sm"><span class="badge badge-mark border-danger-100 mr-1"></span> Closed</div>
														</div>
													</div>
												</td>
												<td>
										...
										<ul class="media-list">
											<li class="media">
												<div class="mr-3 position-relative">
													...
													<span class="badge badge-pink badge-pill badge-float">8</span>
												</div>
											...
											<li class="media">
												<div class="mr-3 position-relative">
													<img src="{{ asset('global_assets/images/placeholders/placeholder.jpg') }}" class="rounded-circle" width="36" height="36" alt="">
													<span class="badge badge-pink badge-pill badge-float">6</span>
												</div>
							...
							<div class="card">
								...
								<div class="card-body">
									...
									<ul class="media-list">
										<li class="media">
											<div class="mr-3">
												<a href="#" class="btn btn-outline-pink rounded-pill border-2 btn-icon"><i class="icon-statistics"></i></a>
											</div>
											
											<div class="media-body">
												Stats for July, 6: <span class="font-weight-semibold">1938</span> orders, $4220 revenue
										...
										<li class="media">
											<div class="mr-3">
												<a href="#" class="btn btn-outline-success rounded-pill border-2 btn-icon"><i class="icon-checkmark3"></i></a>
											</div>
										...
										<li class="media">
											<div class="mr-3">
												<a href="#" class="btn btn-outline-primary rounded-pill border-2 btn-icon"><i class="icon-alignment-unalign"></i></a>
											</div>
										...
										<li class="media">
											<div class="mr-3">
												<a href="#" class="btn btn-outline-warning rounded-pill border-2 btn-icon"><i class="icon-spinner11"></i></a>
											</div>
										...
										<li class="media">
											<div class="mr-3">
												<a href="#" class="btn btn-outline-teal rounded-pill border-2 btn-icon"><i class="icon-redo2"></i></a>
											</div>
